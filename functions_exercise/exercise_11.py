"""
Ćwiczenie 12
Zaimplementuj funkcję o nazwie divisible_by_3_or_5(),
która zwraca listę liczb podzielnych przez 3 lub 5 w
podanym zakresie (z wartościami krańcowymi włącznie).
Przykłady użycia:
