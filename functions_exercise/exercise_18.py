"""
Ćwiczenie 19
Zaimplementuj funkcję o nazwie create_dictionary(),
która będzie tworzyć słownik z przekazanych do niej
argumentów typu klucz-wartość. Funkcja powinna działać
dla dowolnej liczby argumentów. Do tego użyj składni **kwargs,
która pozwala na przekazywanie zmiennej liczby argumentów typu
klucz-wartość do funkcji.
Przykłady użycia:
